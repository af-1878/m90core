...
module sound (
    ...
    // External sample ROM interface (implemented in PSRAM, not BRAM)
    output reg [16:0] sample_rom_addr,
...
wire [7:0] sample_data = sample_rom_data;
reg sample_play = 0;

// sample_rom_addr exposed to core_top for PSRAM bridge
always_comb sample_rom_addr = sample_addr[16:0];
